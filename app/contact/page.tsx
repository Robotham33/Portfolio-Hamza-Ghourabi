          ...
          <div className="mt-5 grid gap-12 lg:grid-cols-[1fr_0.7fr]">
            <div>
              ...
              <p className="mt-6 max-w-2xl text-lg leading-8 text-[var(--muted-foreground)]">
                Pour une mission, un poste ou simplement un échange technique,
                le meilleur point de départ est de me contacter via LinkedIn ou
                GitHub.
              </p>
            </div>
            <div className="space-y-3 lg:pt-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-between rounded-2xl border border-[var(--border)] bg-[var(--surface)] px-5 py-4 transition hover:border-[var(--border-strong)]"
              >
                <span>
                  <span className="block text-xs text-[var(--muted-foreground)]">
                    Réseau professionnel
                  </span>
                  <span className="mt-1 block font-medium">LinkedIn</span>
                </span>
              ...
              <p className="pt-3 text-xs leading-5 text-[var(--muted-foreground)]">
                L’adresse e-mail publique sera ajoutée dès validation du canal
                de contact à afficher.
              </p>
            </div>
          </div>
        </div>
