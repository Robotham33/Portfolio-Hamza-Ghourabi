    ...
    <section className="px-5 pb-18 sm:px-6 lg:px-8 lg:pb-24">
      <div className="mx-auto grid max-w-7xl overflow-hidden border border-[var(--border-strong)] lg:grid-cols-[1fr_250px]">
        <div className="bg-white p-7 sm:p-8 lg:p-10">
          ...
          <Link
            href="/contact"
            className="primary-action mt-6 inline-flex px-5 py-2.5 text-sm font-semibold transition"
          >
            Échanger avec moi <span className="ml-2">↗</span>
          </Link>
        </div>

        <div className="relative flex min-h-[220px] flex-col justify-between bg-[var(--ink)] p-6 text-white">
